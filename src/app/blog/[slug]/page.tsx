  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#0a0a0a", color: "#e5e5e5" }}>
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "48px 24px 100px" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "12px", color: "#737373", fontSize: "15px", marginBottom: "40px", paddingBottom: "32px", borderBottom: "1px solid #262626" }}>
        ...
        <article>{article.content.map((p, i) => renderParagraph(p, i))}</article>
        <Comments slug={slug} />
      </div>
    </div>
  );
