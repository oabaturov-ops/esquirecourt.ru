            ...
            <div style={{ marginBottom: "32px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                <Link href="/blog" style={{
                  ...
                  textDecoration: "none", fontSize: "15px", padding: "6px 12px", borderRadius: "6px",
                  backgroundColor: !selCat && !selTag ? "#1c1c2e" : "transparent",
                  borderLeft: !selCat && !selTag ? "3px solid #c9a84c" : "3px solid transparent", display: "block",
                }}>
                  {"\u0412\u0441\u0435 \u0441\u0442\u0430\u0442\u044C\u0438"}
                </Link>
                {categories.map(cat => (
                  <Link key={cat} href={`/blog?category=${encodeURIComponent(cat)}`} style={{
                    ...
                    borderLeft: selCat === cat ? "3px solid #c9a84c" : "3px solid transparent", display: "block",
                  }}>
                    {cat}
                  </Link>
                ))}
                ...
                {filtered.map(a => (
                  <Link key={a.slug} href={`/blog/${a.slug}`} style={{ textDecoration: "none", color: "inherit" }}>
                    <div style={{ padding: "28px", borderRadius: "12px", border: "1px solid #262626", backgroundColor: "#111" }}>
                      ...
                      <div style={{ display: "flex", flexWrap: "wrap", gap: "12px", fontSize: "14px", color: "#737373" }}>
                        <span>{a.date}</span>
