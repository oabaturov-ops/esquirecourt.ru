  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#0a0a0a", color: "#e5e5e5" }}>
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "48px 24px 100px" }}>
        ...
        {book.pdfUrl && (
          <a href={book.pdfUrl} download style={{ display: "inline-block", padding: "14px 32px", backgroundColor: "#c9a84c", color: "#0a0a0a", borderRadius: "8px", fontWeight: 600, fontSize: "16px", textDecoration: "none" }}>
            {"\u0421\u043A\u0430\u0447\u0430\u0442\u044C PDF"}
          </a>
        )}
        {book.externalUrl && (
          <a href={book.externalUrl} target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", padding: "14px 32px", backgroundColor: "#c9a84c", color: "#0a0a0a", borderRadius: "8px", fontWeight: 600, fontSize: "16px", textDecoration: "none" }}>
            {"\u041E\u0442\u043A\u0440\u044B\u0442\u044C"}
          </a>
        )}
      </div>
